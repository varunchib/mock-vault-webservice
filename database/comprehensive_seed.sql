...
VALUES
  ('upsc-cse',    'UPSC Civil Services Examination',              'UPSC CSE',    'Central',     '🏛️', 2400, 12, 8,  'Union Public Service Commission Civil Services Examination (UPSC CSE) is conducted in three stages (Prelims, Mains, and Interview) to select candidates for IAS, IPS, IFS, and other Group A central services.', '["2024","2023","2022","2021","2020"]', '["Polity","History","Geography","Economy","Environment","Science & Technology","CSAT"]'),
  ('ssc-cgl',     'SSC Combined Graduate Level',                  'SSC CGL',     'Central',     '📋', 3600, 18, 12, 'Staff Selection Commission Combined Graduate Level (SSC CGL) examination recruits candidates for Group B and Group C non-gazetted posts across central government ministries and departments.', '["2024","2023","2022","2021","2020"]', '["Quantitative Aptitude","General Intelligence & Reasoning","English Language","General Awareness"]'),
  ('ssc-chsl',    'SSC Combined Higher Secondary Level',          'SSC CHSL',    'Central',     '📄', 2400, 14, 8,  'Staff Selection Commission Combined Higher Secondary Level (SSC CHSL) examination recruits candidates for LDC, JSA, PA, SA, and DEO posts in central government departments.', '["2024","2023","2022","2021"]', '["Quantitative Aptitude","General Intelligence & Reasoning","English Language","General Awareness"]'),
  ('ssc-mts',     'SSC Multi Tasking Staff',                      'SSC MTS',     'Central',     '📝', 1800, 10, 6,  'Staff Selection Commission Multi Tasking Staff (SSC MTS) examination recruits candidates for Group C non-gazetted, non-ministerial posts in central government offices and departments.', '["2024","2023","2022"]', '["Numerical & Mathematical Ability","Reasoning","General Awareness","English"]'),
  ('ibps-po',     'IBPS Probationary Officer',                    'IBPS PO',     'Banking',     '🏦', 2400, 12, 10, 'Institute of Banking Personnel Selection (IBPS) conducts the Probationary Officer (PO) examination for recruitment to PO and Management Trainee posts across participating public sector banks through Prelims, Mains, and Interview.', '["2024","2023","2022","2021"]', '["Reasoning Ability","Quantitative Aptitude","English Language","General Awareness","Computer Aptitude"]'),
  ('ibps-clerk',  'IBPS Clerk',                                   'IBPS Clerk',  'Banking',     '💳', 1800, 10, 8,  'Institute of Banking Personnel Selection (IBPS) conducts the Clerk examination for recruitment to clerical cadre posts across participating public sector banks through Prelims and Mains stages.', '["2024","2023","2022","2021"]', '["Reasoning Ability","Quantitative Aptitude","English Language","General Financial Awareness"]'),
  ('sbi-po',      'SBI Probationary Officer',                     'SBI PO',      'Banking',     '🏦', 2000, 10, 8,  'State Bank of India (SBI) conducts the Probationary Officer (PO) examination to recruit PO and Management Trainee candidates for SBI branches across India through Prelims, Mains, and Group Exercise & Interview.', '["2024","2023","2022","2021"]', '["Reasoning & Computer Aptitude","Data Analysis & Interpretation","English Language","General Awareness"]'),
  ('rrb-ntpc',    'RRB Non-Technical Popular Categories',         'RRB NTPC',    'Railways',    '🚂', 2800, 14, 10, 'Railway Recruitment Board (RRB) Non-Technical Popular Categories (NTPC) examination recruits candidates for Junior Clerk, Accounts Clerk, Traffic Assistant, Goods Guard, and other non-technical posts in Indian Railways.', '["2024","2023","2022","2021"]', '["Mathematics","General Intelligence & Reasoning","General Awareness"]'),
  ('rrb-group-d', 'RRB Group D',                                  'RRB Group D', 'Railways',    '🔧', 2000, 10, 8,  'Railway Recruitment Board (RRB) Group D examination recruits candidates for Track Maintainer, Helper, Assistant Pointsman, and other Level 1 posts across various departments of Indian Railways.', '["2024","2023","2022"]', '["Mathematics","General Intelligence & Reasoning","General Science","General Awareness"]'),
  ('ctet',        'Central Teacher Eligibility Test',             'CTET',        'Teaching',    '📚', 1600, 8,  6,  'Central Teacher Eligibility Test (CTET) conducted by CBSE certifies the eligibility of candidates for teaching Classes I-VIII in central government schools, covering Child Development, Pedagogy, and subject knowledge.', '["2024","2023","2022","2021"]', '["Child Development & Pedagogy","Language I","Language II","Mathematics","Environmental Studies"]'),
  ('jee-main',    'JEE Main',                                     'JEE Main',    'Engineering', '⚙️', 2400, 12, 8,  'National Testing Agency (NTA) conducts Joint Entrance Examination Main (JEE Main) for admission to NITs, IIITs, and GFTIs, and as a qualifying exam for JEE Advanced for IIT admission.', '["2024","2023","2022","2021"]', '["Physics","Chemistry","Mathematics"]'),
  ('jkssb',       'Jammu & Kashmir Services Selection Board',     'JKSSB',       'States',      '📜', 1600, 10, 8,  'Jammu & Kashmir Services Selection Board (JKSSB) conducts competitive examinations for recruitment to non-gazetted posts under J&K government departments, including Finance Accounts Assistant, Junior Assistant, Patwari, VLW, and Wildlife Guard.', '["2024","2023","2022","2021"]', '["Public Finance","Accountancy","J&K General Knowledge","General Intelligence & Reasoning","Quantitative Aptitude"]'),
  ('neet-ug',     'NEET UG',                                      'NEET UG',     'Medical',     '🧬', 2400, 12, 8,  'National Eligibility cum Entrance Test (NEET UG) conducted by the National Testing Agency (NTA) determines admission to MBBS, BDS, BAMS, BSMS, and other undergraduate medical and allied health science programmes across India.', '["2024","2023","2022","2021","2020"]', '["Biology","Physics","Chemistry"]')
