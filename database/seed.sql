...
VALUES
  ('upsc-cse', 'UPSC Civil Services Examination', 'UPSC CSE', 'Central', '🏛️', 18000, 120, 85, 'Solved UPSC Prelims and Mains previous year questions with explanations, answer keys, topic filters, and free practice mocks.', '["2024","2023","2022","2021"]', '["Polity","History","Geography","Economy","Environment","CSAT"]'),
  ('ssc-cgl', 'SSC CGL', 'SSC CGL', 'Central', '📋', 24000, 180, 120, 'SSC CGL tier-wise PYQs, all shifts, solved answers, reasoning, quant, English, and GK practice sets.', '["2024","2023","2022","2021"]', '["Quantitative Aptitude","General Intelligence & Reasoning","English Language","General Awareness"]'),
  ('jkssb', 'JKSSB Exams', 'JKSSB', 'J&K', '📜', 8000, 70, 45, 'JKSSB previous year papers for Finance, Accounts, VLW, Patwari, and other posts with explanations and answer keys.', '["2024","2023","2022","2021"]', '["Public Finance","Accountancy","J&K General Knowledge","General Intelligence & Reasoning","Quantitative Aptitude"]'),
  ('neet-ug', 'NEET UG', 'NEET UG', 'Medical', '🧬', 12000, 90, 100, 'NEET UG biology, physics, and chemistry previous year questions with chapter-wise explanations and free practice.', '["2024","2023","2022","2021"]', '["Biology","Physics","Chemistry"]')
