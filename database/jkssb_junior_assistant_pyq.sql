...
'D','a, an','"a" Canadian (consonant sound /k/); "an" hour (silent h, vowel sound /aÊŠ/).','[]',CURRENT_TIMESTAMP),
...
'C','Hear','"Hear" has the homophone "Here" â€” they sound identical but have different meanings and spellings.','[]',CURRENT_TIMESTAMP),
...
'B','Conformity','Idiosyncrasy means a peculiar habit or characteristic. Its antonym is conformity â€” adhering to accepted norms.','[]',CURRENT_TIMESTAMP),
...
'B','A farewell party is being organized by them next week.','Active present continuous â†’ passive: object becomes subject, "is being organized" is used, and agent "by them" is retained.','[]',CURRENT_TIMESTAMP),
...
'B','286','Pattern: 336-64(8Â²)=272, 272+49(7Â²)=321, 321-36(6Â²)=285 (not 286), 285+25(5Â²)=310, 310-16(4Â²)=294. So 286 should be 285.','[]',CURRENT_TIMESTAMP),
...
'D','73.125','Pattern: Ã·2, Ã—3, Ã·4, Ã—5, Ã·6. So 438.75 Ã· 6 = 73.125.','[]',CURRENT_TIMESTAMP),
...
'C','You cannot modify font and background in slide master','In Slide Master view, you CAN modify fonts, backgrounds, colors, and layouts â€” that is in fact its primary purpose.','[]',CURRENT_TIMESTAMP),
...
'Which Indian state shares borders with three countries â€” Nepal, Bhutan, and China?',
...
'B','31-10-2019','Following the Jammu and Kashmir Reorganisation Act, 2019, J&K was bifurcated into two UTs â€” Jammu & Kashmir and Ladakh â€” on 31 October 2019.','[]',CURRENT_TIMESTAMP),
...
'B','Drass','Drass in Kargil district, Ladakh, is the coldest inhabited place in India and the second coldest inhabited place in the world, with temperatures dropping to -45Â°C.','[]',CURRENT_TIMESTAMP),
...
'P and Q are positive integers where P Ã— Q = 64. Which of the following CANNOT be the value of P + Q?',
'[{"key":"A","text":"16"},{"key":"B","text":"20"},{"key":"C","text":"35"},{"key":"D","text":"65"}]'::jsonb,
'C','35','Factor pairs of 64: (1,64)â†’65, (2,32)â†’34, (4,16)â†’20, (8,8)â†’16, (32,2)â†’34. No pair sums to 35.','[]',CURRENT_TIMESTAMP),
...
'A','8%','Using the formula: n(FâˆªC) = n(F) + n(C) - n(Fâˆ©C). Those who play at least one sport = 100-18 = 82%. So 82 = 40+50-n(both), n(both) = 90-82 = 8%.','[]',CURRENT_TIMESTAMP),
...
'The average of 12 numbers â€” 3, 11, 7, 9, 15, 13, 8, 19, 17, 21, 14, x â€” is 12. Find x.',
'[{"key":"A","text":"17"},{"key":"B","text":"15"},{"key":"C","text":"27"},{"key":"D","text":"7"}]'::jsonb,
'D','7','Sum of 12 numbers = 12 Ã— 12 = 144. Sum of known 11 numbers = 3+11+7+9+15+13+8+19+17+21+14 = 137. So x = 144-137 = 7.','[]',CURRENT_TIMESTAMP),
...
'D','34.7','Total sum = 100Ã—35 = 3500. Correct sum = 3500 - 83 + 53 = 3470. Correct average = 3470/100 = 34.7.','[]',CURRENT_TIMESTAMP),
...
'B','51.2 kg','Total = (6Ã—50)+(2Ã—51)+(2Ã—55) = 300+102+110 = 512. Average = 512/10 = 51.2 kg.','[]',CURRENT_TIMESTAMP),
...
'A','Rs. 724.50','Transport cost = 5% of 600 = 30. Total cost = 630. Selling price = 630 Ã— 1.15 = Rs. 724.50.','[]',CURRENT_TIMESTAMP),
...
'C','Rs. 1000','SP = CP Ã— (1 - 4/100). 960 = CP Ã— 0.96. CP = 960/0.96 = Rs. 1000.','[]',CURRENT_TIMESTAMP),
...
'A','Rs. 80,000','SP = CP Ã— (1 - 20/100). 64000 = CP Ã— 0.80. CP = 64000/0.80 = Rs. 80,000.','[]',CURRENT_TIMESTAMP),
...
'B','East','Start facing East â†’ go 5 km East â†’ turn right (now facing South) â†’ go 4 km South â†’ turn left (now facing East) â†’ go 5 km East. Final direction: East.','[]',CURRENT_TIMESTAMP),
...
'B','East','South â†’ turn left (now East) â†’ turn right (now South) â†’ turn left (now East). Final direction: East.','[]',CURRENT_TIMESTAMP),
...
'A','OLGFH','Each letter maps to its reverse alphabet counterpart (Aâ†”Z, Bâ†”Y, ...). L(12)â†’O(15), O(15)â†’L(12), T(20)â†’G(7), U(21)â†’F(6), S(19)â†’H(8). LOTUS â†’ OLGFH.','[]',CURRENT_TIMESTAMP),
...
'A','RASHMI','Using the same reverse alphabet code (Aâ†”Z, Bâ†”Y...): Iâ†’R, Zâ†’A, Hâ†’S, Sâ†’H, Nâ†’M, Râ†’I. IZHSNR â†’ RASHMI.','[]',CURRENT_TIMESTAMP),
